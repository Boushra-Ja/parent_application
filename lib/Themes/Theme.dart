...
class Themes{
  ...
  static Color blue =  Colors.black38;
  static Color orange = Colors.red.shade500;
  static Color orange2 = Colors.grey.shade100;
  static Color white = Colors.white;
  static Color grey = Colors.grey.shade300;
  static const secondary = Color(0xFFee1d32 );
  static const primary = Color(0xFF0f2032  );
  ...
  static  TextStyle bodyline3 =  TextStyle(fontSize: 12 , color: Colors.black38) ;
